...
38 records · iteration 117 · phase grow

**Line:** idea:3 → spec:4 → building:0 → rc:6 → published:25 · deprecated:0 · shelved:0
...
- [test-gap-nudge v0.1.0](records/test-gap-nudge.md) `quality` `hooks` — A polite Stop-hook that notices source changes with no matching test changes and says so once. — install: `/plugin install test-gap-nudge@foundry`
