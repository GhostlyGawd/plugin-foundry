...
38 records · iteration 155 · phase grow
...
- [night-clerk v0.2.0](records/night-clerk.md) `workflow` `skills` — Ask Claude Code what plugin helps with X - the clerk searches the foundry catalog and hands you the install line. — install: `/plugin install night-clerk@foundry`
